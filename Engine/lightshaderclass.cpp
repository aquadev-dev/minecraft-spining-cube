										   ...
										   ID3D11ShaderResourceView* texture, XMFLOAT3 lightDirection, XMFLOAT4 ambientColor, XMFLOAT4 diffuseColor)
{
	...
	dataPtr2->ambientColor = ambientColor; //Setting the ambientColour for the constant buffer to get access in the pixel shader to at least provide this colour to all pixels. 
